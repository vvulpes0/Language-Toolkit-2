...
are fixed.  Labels of paths are (Symbol e)
...
>                      (difference
>                       (states psgR)
>                       (insert (State empty) (FSA.initials psgR)))
> 
...
>                              (transitions psg) )
>                  (FSA.initials psg) (FSA.finals psg) (isDeterministic psg)
> 
