...
Get name of pattern from first argument for dotifyWithName  
...
>       writeFile (name++"."++ext++".dot") (dotifyWithName (deFang name) fsa)
>       return fsa
...
>                      String -> (FSA b a) -> IO (FSA (Set.Set Int) a)
> writePSG name fsa =
>     do
